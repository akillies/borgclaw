...
```
Subject: [Short, specific, not generic — reference something real]

[3-5 sentences. Warm, genuine, specific.]
[Reference something from the last interaction or their work.]
[Include a lightweight ask or value offer — not transactional.]
[Sign off naturally.]
```
...
- Never be transactional ("Just checking in to see if you need anything")
- If revenue contact: frame as offering value, not asking for work
- If creative collaborator: reference the shared project or idea

## Anti-Patterns (instant fail)
- "I hope this email finds you well"
- "Just wanted to circle back"
- "Let me know if there's anything I can do"
- "I know it's been a while since we connected"
- "Touching base"
- Any em-dash used as dramatic pause
- Any sentence starting with "But here's the thing"
...
[Connect it to shared work or upcoming event]
